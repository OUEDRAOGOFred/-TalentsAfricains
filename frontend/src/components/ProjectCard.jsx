      ...
      <Link to={`/project/${project.id}`} className="project-card-link">
        ...
        <div className="project-card-footer">
          <div className="project-stats">
            <span className="stat" style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
              <svg style={{ width: '16px', height: '16px', flexShrink: 0, display: 'block' }} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" stroke="#d4a574" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
              {project.likes_count || 0}
            </span>
            <span className="stat" style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
              <svg style={{ width: '16px', height: '16px', flexShrink: 0, display: 'block' }} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" stroke="#d4a574" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
              {project.comments_count || 0}
            </span>
            <span className="stat" style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
              <svg style={{ width: '16px', height: '16px', flexShrink: 0, display: 'block' }} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" stroke="#d4a574" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
                <circle cx="12" cy="12" r="3" stroke="#d4a574" strokeWidth="2.5"/>
              </svg>
